...
typedef	struct _pipe {
	...
	CRITICAL_SECTION			buf_lock;				//Must be acquired before operation the buf
	HANDLE						read_event;				//Be set when the pipe is read
	HANDLE						write_event;			//Be set when the pipe is written
} pipe, *ppipe;
